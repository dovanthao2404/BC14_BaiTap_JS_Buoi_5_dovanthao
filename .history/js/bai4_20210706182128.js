...
function checkValid() {
  ...
  var result4 = checkEntry("premiumChannel", "notificationPremium", 3) && checkIsNumber("premiumChannel", "notificationPremium", 5) && checkValueNumber("premiumChannel", "notificationPremium", 7);

  if (result2) {

    var result3 = checkEntry("connectionNumber", "notificationConnection", 2) && checkIsNumber("connectionNumber", "notificationConnection", 4) && checkValueNumber("connectionNumber", "notificationConnection", 6);
...
function getNumberChannelPremium() {
  console.log(+getEle("premiumChannel").value);
...
function calculateCableFeePersonal() {
  ...
  var total = 4.5 + 20.5 + (7.5 * premiumChannel);
  return total;
}
