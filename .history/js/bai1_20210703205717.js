...
function checkAreaScores() {
  ...
  if (contentArea.toUpercase() === 0 ||
    contentArea.toUpercase() === 1 ||
...
function checkObjectScores() {
  ...
  if (contentBoject.toUpercase() === 0 ||
    contentBoject.toUpercase() === 1 ||
    contentBoject.toUpercase() === 'B' ||
    contentBoject.toUpercase() === 'C') {
