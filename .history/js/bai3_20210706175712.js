...
var notifications = [
  ...
  "Tên không được là ký tự hoặc số!",
]
...
function checkValid() {
  var result1 = checkEntry("fullName", "notifiName", 0) && checkName("fullName", "notifiName", 6);
  var result2 = checkEntry("totalIncome", "notifiIncome", 1) && checkIsNumber("totalIncome", "notifiIncome", 3) && checkValueNumber("totalIncome", "notifiIncome", 4);
  var result3 = checkEntry("dependents", "notifiDependent", 2) && checkIsNumber("dependents", "notifiDependent", 3) && checkValueNumber("dependents", "notifiDependent", 5);
...
function calculateTaxLevel2(taxableIncome) {
  var TaxLevel1 = calculateTaxLevel1(60e6);
  return (taxableIncome - 60e6) * TAX_PERCENTAGE_LEVEL_2 + TaxLevel1;
}

// tính tiền thuế bậc 3
function calculateTaxLevel3(taxableIncome) {
  var TaxLevel2 = calculateTaxLevel2(120e6);
  return (taxableIncome - 120e6) * TAX_PERCENTAGE_LEVEL_3 + TaxLevel2;
}

// tính tiền thuế bậc 4
function calculateTaxLevel4(taxableIncome) {
  var TaxLevel3 = calculateTaxLevel3(210e6);
  return (taxableIncome - 210e6) * TAX_PERCENTAGE_LEVEL_4 + TaxLevel3;
}

// tính tiền thuế bậc 5
function calculateTaxLevel5(taxableIncome) {
  var TaxLevel4 = calculateTaxLevel4(384e6);
  return (taxableIncome - 384e6) * TAX_PERCENTAGE_LEVEL_5 + TaxLevel4;
}

// tính tiền thuế bậc 6
function calculateTaxLevel6(taxableIncome) {
  var TaxLevel5 = calculateTaxLevel5(624e6);
  return (taxableIncome - 624e6) * TAX_PERCENTAGE_LEVEL_6 + TaxLevel5;
}

// tính tiền thuế bậc 7
function calculateTaxLevel7(taxableIncome) {
  var TaxLevel6 = calculateTaxLevel6(960e6);
  return (taxableIncome - 960e6) * TAX_PERCENTAGE_LEVEL_7 + TaxLevel6;
}
