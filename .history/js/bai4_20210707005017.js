...
function calculateCableFeeEnterprise() {
  ...
  if (connectionNumber <= 10) {
    total = INVOICE_HANDLING_FEE_ENTERPRISE + BASIC_SERVICE_FEE_ENTERPRISE_FIRST * connectionNumber + premiumChannel * PREMIUM_SERVICE_FEE_ENTERPRISE;
    return total;
  }

  total = INVOICE_HANDLING_FEE_ENTERPRISE + BASIC_SERVICE_FEE_ENTERPRISE_FIRST * 10 + (BASIC_SERVICE_FEE_ENTERPRISE_SECOND * (connectionNumber - 10)) + premiumChannel * PREMIUM_SERVICE_FEE_ENTERPRISE;
  return total;
}
