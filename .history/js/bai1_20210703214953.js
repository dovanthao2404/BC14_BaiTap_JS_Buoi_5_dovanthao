...
function checkAreaScores() {
  ...
  if (toUperCase(contentArea) === 'X' ||
    toUperCase(contentArea) === 'A' ||
    toUperCase(contentArea) === 'B' ||
    toUperCase(contentArea) === 'C') {
    return contentArea;
  } else {
    return false;
  }
...
function checkValid() {
  ...
  if (check1) {
    ...
    if (check1) {
      check1 = checkValueScores("scores-1", "notificationScores-1", 5);
    }
  }
  ...
  if (check2) {
    ...
    if (check2) {
      check2 = checkValueScores("scores-2", "notificationScores-2", 5);
    }
  }
  ...
  if (check3) {
    ...
    if (check3) {
      check3 = checkValueScores("scores-3", "notificationScores-3", 5);
    }
  }
  var check4 = checkEntry("areaScores", "notificationArea", 3);
  if (check4) {
    check4 = checkAreaScores();
  }
